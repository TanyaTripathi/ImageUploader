...
public class ImageControllerTest {
    ...
    public void getUserImages() throws Exception {
        ...
        userProfile.setId(1);
        userProfile.setEmailAddress("tanya@gmail.com");
        userProfile.setFullName("Tanya Pandey");
        userProfile.setMobileNumber("9821077783");
        user.setProfile(userProfile);
        user.setId(1);
        user.setUsername("Tpandey");
    ...
    public void editImageWithNonOwnerOfTheImage() throws Exception {
        ...
        userProfile.setId(2);
        userProfile.setEmailAddress("k@gmail.com");
        userProfile.setFullName("karnika");
        userProfile.setMobileNumber("9876543210");
        user.setProfile(userProfile1);
        user.setId(2);
        user.setUsername("karnika");
        user.setPassword("password1@@");
